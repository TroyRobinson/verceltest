    ...
    'node_modules/react/cjs/react.development.js'(
      ...
      if (true) {
        ;(function () {
          ...
          var REACT_FRAGMENT_TYPE = Symbol.for(
            'react.fragment',
          )
          var REACT_STRICT_MODE_TYPE = Symbol.for(
            'react.strict_mode',
          )
          var REACT_PROFILER_TYPE = Symbol.for(
            'react.profiler',
          )
          var REACT_PROVIDER_TYPE = Symbol.for(
            'react.provider',
          )
          var REACT_CONTEXT_TYPE =
            Symbol.for('react.context')
          var REACT_FORWARD_REF_TYPE = Symbol.for(
            'react.forward_ref',
          )
          var REACT_SUSPENSE_TYPE = Symbol.for(
            'react.suspense',
          )
          ...
          var REACT_OFFSCREEN_TYPE = Symbol.for(
            'react.offscreen',
          )
          ...
          function printWarning(level, format, args) {
            {
              ...
              var argsWithFormat = args.map(function (
                item,
              ) {
                return String(item)
              })
              ...
              for (var typeSpecName in typeSpecs) {
                if (has(typeSpecs, typeSpecName)) {
                  ...
                  if (
                    ...
                    loggedTypeFailures[error$1.message] =
                      true
                    setCurrentlyValidatingElement(element)
                    error(
                      'Failed %s type: %s',
          ...
          function createFactoryWithValidation(type) {
            var validatedFactory =
              createElementWithValidation.bind(null, type)
